...
const Header = () => {
  ...
  return <header className={`fixed z-50 w-full transition-all ${active ? 'bg-[#030315] py-6' : 'bg-transparent py-8'}`}>
    <div className='container mx-auto flex flex-col xl:flex-row items-center justify-between' >
      ...
      <NavMobile />
      <div className="absolute right-7 top-9 z-10 xl:hidden"><MenuBtn /></div>
